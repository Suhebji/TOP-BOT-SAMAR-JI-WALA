        ...
        switch (logMessageType) {
            ...
            case "log:thread-call": {
                if (logMessageData.event == "group_call_started") {
                    ...
                    api.sendMessage(`❯❯❯⭑𝐆𝐑𝐎𝐔𝐏 𝐔𝐏𝐃𝐀𝐓𝐄 ⭑❮❮❮\n᯽ـــــــــــــــــ𝐒𝐔𝐇𝐄𝐁ــــــــــــــــــ᯽\n𓆩𑁍𓆪${name} ᭄࿐𓆩𑁍𓆪\n᯽ـــــــــــــــــــــ𝐊𝐇𝐀𝐍ـــــــــــــــــ᯽\n ⭑｟𝐒𝐓𝐀𝐑𝐓𝐄𝐃 𝐀 ${(logMessageData.video) ? '𝐕𝐈𝐃𝐄𝐎｠⭑ ' : ''}𝐂𝐀𝐋𝐋｠⭑`, threadID);
                }
                    ...
                    api.sendMessage(`❯❯❯⭑𝐆𝐑𝐎𝐔𝐏 𝐔𝐏𝐃𝐀𝐓𝐄 ⭑❮❮❮\n᯽ـــــــــــــــ𝐬𝐮𝐡𝐞𝐛ـــــــــــــــــــــــ᯽\n𓆩𑁍𓆪${name} ᭄࿐𓆩𑁍𓆪\n᯽ــــــــــــــــــــ𝐤𝐡𝐚𝐧ــــــــــــــــــ᯽\n⭑｟𝐉𝐎𝐈𝐍𝐄𝐃 𝐓𝐇𝐄 ${(logMessageData.group_call_type == '1') ? '𝐕𝐈𝐃𝐄𝐎｠⭑ ' : ''}𝐂𝐀𝐋𝐋｠⭑`, threadID);
                }
                break;
            }
